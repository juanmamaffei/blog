...
<div  data-label="Features" data-id="features-13-card-bordered" data-export-id="features-13-card-bordered" data-category="features" class="features-13 content-section content-section-spacing" id="features-7" style="background-color: #f5fafd;">
    ...
    </div><div  data-label="About" data-id="about-images-right-section" data-export-id="about-images-right-section" data-category="about" class="about-images-right-section content-section content-section-spacing" id="about-12" style="background-color: rgb(245, 250, 253);"> <div  class="gridContainer"> <div  class="row middle-sm text-center"> <div  class="col-sm-5 content-left-sm" data-type="column"> <h5  class=""> LOREM IPSUM DOLOR </h5> <h2  class=""> Enjoy the best <br > <span  style="font-family: Playfair Display, sans-serif; font-weight: 700; font-style: italic;" href="#"> design and functions </span> combined together </h2> <p  class=""> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p> <a  class="button color1" href="#"> GET STARTED NOW </a> </div> <div  class="col-sm-7"> <div  class="image-group-side-3-img"> <img  class="topimg shadow-large" src="https://extendthemes.com/mesmerize/demos/demo-free-2/wp-content/uploads/2018/04/cropped-msm-header-9-1.jpg"> <img  class="rightimg shadow-large" src="https://extendthemes.com/mesmerize/demos/demo-free-2/wp-content/uploads/2018/04/cropped-portfolio-4.jpg"> <div  class="leftimg"> <img  class="shadow-large" src="https://extendthemes.com/mesmerize/demos/demo-free-2/wp-content/uploads/2018/04/cropped-msm-header-11.jpg"> </div> </div> </div> </div> </div> </div><div  data-label="Cta" data-id="cta-blue-section" data-export-id="cta-blue-section" data-category="cta" class="cta-blue-section content-section content-section-spacing-medium bg-color1 white-text" id="cta-1">
    <div  class="gridContainer">
    ...
    </div><div  data-label="Counters" data-id="counters-1" data-export-id="counters-1" data-category="counters" class="counters-1 content-section content-section-spacing" id="counters-1" style="background-color: rgb(245, 250, 253); background-image: none;">
    <div  class="gridContainer">
    <div  class="row text-center">
    <div  class="section-title-col" data-type="column">
    <h2  class="">Our work in numbers</h2>
    ...
    </div><div  data-label="Team" data-id="team-5" data-export-id="team-5" data-category="team" class="team-5 content-section content-section-spacing" id="team-5" style="background-color: #ffffff;">
    <div  class="gridContainer">
    <div  class="row text-center">
    <div  class="section-title-col" data-type="column">
    ...
    <img  class="round face" src="https://extendthemes.com/mesmerize/demos/demo-free-2/wp-content/plugins/mesmerize-companion/theme-data/mesmerize/sections/images/team-1.jpg">
    <h4  class="end font-500">Eleanor Fant</h4>
    ...
    <img  class="round face" src="https://extendthemes.com/mesmerize/demos/demo-free-2/wp-content/plugins/mesmerize-companion/theme-data/mesmerize/sections/images/team-2.jpg">
    <h4  class="end font-500">Brandon Guidelines</h4>
    <p  class="italic">job title</p>
    <p  class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
    ...
    <img  class="round face" src="https://extendthemes.com/mesmerize/demos/demo-free-2/wp-content/plugins/mesmerize-companion/theme-data/mesmerize/sections/images/team-3.jpg">
    <h4  class="end font-500">Sue Shei</h4>
    <p  class="italic">job title</p>
    <p  class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
    ...
    <img  class="round face" src="https://extendthemes.com/mesmerize/demos/demo-free-2/wp-content/plugins/mesmerize-companion/theme-data/mesmerize/sections/images/team-4.jpg">
    <h4  class="end font-500">Willma Barrow</h4>
    <p  class="italic">job title</p>
    <p  class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
